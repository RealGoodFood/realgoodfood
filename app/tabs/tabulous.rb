...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #----------------------------------------------------------------------------------------------------#
      [    :home_tab        ,    'Dashboard'     ,    root_path          ,    true        ,    true        ],
      [    :groups_tab      ,    'Groups'        ,    groups_path        ,    true        ,    true        ],
      [    :listings_tab    ,    'Listings'      ,    listings_path      ,    true        ,    true        ],
      [    :events_tab      ,    'Events'        ,    events_path        ,    true        ,    true        ],
      [    :locations_tab   ,    'Location'      ,    locations_path     ,    true        ,    true        ],
      #----------------------------------------------------------------------------------------------------#
      #    TAB NAME         |    DISPLAY TEXT    |    PATH               |    VISIBLE?    |    ENABLED?    #
      #----------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      [    :groups       ,    :all_actions    ,    :groups_tab      ],
      [    :listings     ,    :all_actions    ,    :listings_tab    ],
